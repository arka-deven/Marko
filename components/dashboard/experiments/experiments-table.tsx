...
import { FlaskConical, Clock, CheckCircle2, XCircle, Pause, Filter } from "lucide-react"
      ...
      <div className="rounded-2xl bg-card/80 border border-border overflow-hidden">
        ...
        {experiments.length === 0 ? (
          <div className="px-5 py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">No experiments yet. Launch an idea or create one manually.</p>
          </div>
        ) : (
